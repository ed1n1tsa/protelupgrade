    ...
    <section className="px-6 my-10">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="bg-blue-100 rounded-lg p-6 flex flex-col justify-between w-full lg:max-w-[300px]">
          <div>
            <h3 className="text-lg font-bold mb-2">Популярные Категории</h3>
            ...
            <Link href="#" className="text-sm font-medium text-black hover:text-orange-500 flex items-center">
              Купить сейчас <span className="ml-1">→</span>
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1">
          <ProductCard
            image="/jbl.jpg"
            title="JBL Clip 4 Оранжевый Портативный динамик"
            price="80 000 тг"
            oldPrice="90 000 тг"
            rating={4}
          />
          ...
          <ProductCard
            image="/xbox.jpg"
            title="Xbox Wireless Игровой контроллер"
            price="123 000 тг"
            oldPrice="150 000 тг"
            rating={0}
          />
