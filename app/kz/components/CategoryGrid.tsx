...
const categories = [
  { title: 'Ойындар', image: '/icons/game.png', href: '#' },
  { title: 'Электроника', image: '/icons/electronics.png', href: '#' },
  { title: 'Динамиктер', image: '/icons/speaker.png', href: '#' },
  { title: 'Құлаққаптар', image: '/icons/headphones.png', href: '#' },
  { title: 'Смартфондар', image: '/icons/mobile.png', href: '#' },
]

export default function CategoryGrid() {
  return (
    <section className="px-6 my-10">
      <h2 className="text-2xl font-bold mb-6">Санаттар</h2>
