...
export default function AdminProductsPage() {
  ...
  if (loading) return <p className="p-6">Тауарлар жүктелуде...</p>

  return (
    <main className="p-10">
      <h1 className="text-2xl font-bold mb-6">Барлық тауарлар</h1>

      <div className="mb-6 p-4 border rounded bg-gray-50">
        <h2 className="text-lg font-semibold mb-2">➕ Жаңа тауар</h2>
      ...
      <table className="w-full text-sm border bg-white">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="border px-2 py-1">Бағасы</th>
            <th className="border px-2 py-1">Қалдық</th>
            <th className="border px-2 py-1">Қол жетімді</th>
